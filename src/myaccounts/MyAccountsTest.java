...
public class MyAccountsTest extends Utility {
    ...
    public void verifyThatUserRegisterAccountSuccessfully() throws InterruptedException {
        ...
        selectMyAccountOptions("Register");
        Thread.sleep(2000);
        sendTextToElement(By.id("input-firstname"), "Krupali");
        sendTextToElement(By.id("input-lastname"), "Lalkia");
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully() {
        clickOnElement(By.xpath("//span[text()='My Account']"));
        selectMyAccountOptions("Login");
        sendTextToElement(By.id("input-email"), "krupali@gmail.com");
        sendTextToElement(By.id("input-password"), "krupali123");
