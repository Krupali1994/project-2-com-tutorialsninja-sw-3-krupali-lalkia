...
public class LaptopsAndNotebooksTest extends Utility {
    ...
    public void verifyThatUserPlaceOrderSuccessfully() throws InterruptedException {
        ...
        Thread.sleep(2000);
        sendTextToElement(By.id("input-payment-firstname"), "Krupali");
        sendTextToElement(By.id("input-payment-lastname"), "Lalkia");
        sendTextToElement(By.id("input-payment-email"), "krupali@gmail.com");
        sendTextToElement(By.id("input-payment-telephone"), "07987654321");
        Thread.sleep(2000);

        sendTextToElement(By.id("input-payment-address-1"), "10 Windsor Road");
        sendTextToElement(By.id("input-payment-city"), "London");
        sendTextToElement(By.id("input-payment-postcode"), "SW3 7TL");
        selectByVisibleText(By.id("input-payment-country"), "123");
        selectByVisibleText(By.id("input-payment-zone"), "2222");
